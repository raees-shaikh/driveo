...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('frontend/images/fevicon.png') }}">
                            ...
                            <div class="col col-12 my-2">
                                <a class="home-link" href="{{ url('') }}" title="driveo" rel="home">
                                    <img id="logo-img" height="35" width="155"
                                        class="img-fluid auto_size mt-3" src="frontend/images/logo.png"
                                        alt="logo-img">
                                </a>
                            </div>
                            <div class="col col-12 py-2">
                                <h1 class="my-0 py-0 h2"><span class="brand-name">Reset Password</span></h1>

                            </div>
                        </div>
                        <p class="signup-link text-center py-0 my-3 text-capitalize">Enter your email address to receive a link to reset
                            password!</p>
                        <form class="text-left" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form">
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input class="py-0" id="email" name="email" type="email" value=""
